...
class Api::V1::Timelines::MessengerController < Api::BaseController
  ...
  def load_statuses
    cached_messenger_statuses
  end

  def cached_messenger_statuses
    cache_collection messenger_statuses, Status
  end

  def messenger_statuses
    messenger_timeline_statuses.paginate_by_max_id(
